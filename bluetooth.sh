...
function reset_all_controller_settings(){

	function press_enter
	{
	echo ""
	echo -n "Taste A drücken um fortzufahren..."
	read 
	clear
}

	# Controller zurücksetzen / Einstellungen löschen
	clear
	echo "A-Taste drücken um den Vorgang zu starten.."
	read -p "Controller werden zurückgesetzt / Alle Einstellungen gelöscht"
	press_enter
	sudo rm -rf /var/lib/bluetooth && sudo rm -rf /home/pi/.emulationstation/es_input.cfg && sudo rm -rf /opt/retropie/configs/all/retroarch-joypads/*
	sudo mkdir /var/lib/bluetooth && chmod 777 /var/lib/bluetooth/
	read -p "Setup wird gestartet." 
	echo ""
	echo "Infos und Hilfe -> http://www.retronova.net"
	echo "-------------------------------------------------------------------------"
	echo ""
	echo "Im Menü auswählen: Manage Packages > Core Packages > emulationstation"
	echo "Configuration > Clear/Reset Emulation Station input configuration"
	echo ""
	echo ""
	echo "Alle Tasten müssen nach dem Start neu konfiguriert werden."
	echo "Controller wie in der Anleitung beschrieben anmelden."
	echo ""
	echo "Danach im Bluetooth Menü FIX Controller Problem auswählen."
	echo ""
	echo "-------------------------------------------------------------------------"
	echo ""
	press_enter
...
function fix_controller(){
	...
	clear
	echo "A-Taste drücken um den Vorgang zu starten.."
	read -p "Controller Probleme beheben... "
	clear
	echo "Infos und Hilfe -> http://www.retronova.net"
	echo "-------------------------------------------------------------------------"
	echo ""
	echo "Versuche die Controller nach Anleitung mit dem Gerät zu verbinden..."
	echo "Sollte dies nicht möglich sein im Bluetoothmenü die Option"
	echo "Reset all Controller & Settings ausführen"
	echo ""
	echo "-------------------------------------------------------------------------"
	press_enter
	sudo chmod 777 /var/lib/bluetooth/* && sudo chmod 777 /home/pi/.emulationstation/es_input.cfg && chmod 777 /opt/retropie/configs/all/retroarch-joypads/
	sudo ./sixpair
	read -p "Vorgang abgeschlossen.Das Gerät wird neu gestartet..."
	echo "PS-Taste am Controller drücken sobald der Retronova Handheld gestartet hat"
	echo
	echo ""
	echo ""
	echo "   *          *     *        *         *        *    *          "
	echo "       *                 *        *          *            *     "
	echo "      *    *         *          *         *    *            *   "
	echo "    *  BBBB  II TTTTTT NN    NN II  GGGGG HH HH TTTTTT  *       "
	echo "  *    BB BB II TTTTTT NNNN  NN II GG     HH HH TTTTTT      *   "
	echo "  @by  BBBB  II   TT   NN NN NN II GG GGG HHHHH   TT    *       "
	echo " *     BB BB II   TT   NN   NNN II GG  GG HH HH   TT *        * "
	echo "    *  BBBB  II   TT   NN    NN II GGGGGG HH HH   TT    *       "
	echo "        *                *      *         *        *      *     "
	echo "    *          *     *              *         *        *        "
	echo
	sleep 3
...
function gui_bluetooth() {
    ...
    while true; do
	    ...
	    A "Reset all Controller &  Settings"
	    E "FIX Controller Problem"
